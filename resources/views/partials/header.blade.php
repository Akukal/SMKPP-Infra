<header id="mainHeader" class="fixed top-0 left-0 w-full z-50 transition-all duration-300 font-light">
    ...
    <div class="container mx-auto flex items-center justify-between py-3 px-4">
        ...
        <div class="flex items-center space-x-4">
            ...
            <span id="logoText" class="font-bold text-xl text-white" data-translate-key="school_name">SMK Prestasi Prima</span>
        </div>
                ...
                <div id="menu-student_life" class="absolute top-full left-0 mt-2 w-56 rounded-md shadow-lg bg-white hidden origin-top-left">
                    <div class="py-1">
                        ...
                        <div class="relative group/level2">
                            <a href="#" class="w-full flex justify-between items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" data-translate-key="achievements">
                                Prestasi
                                <svg class="w-4 h-4 transform -rotate-90" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                            </a>
                            <div class="absolute top-0 left-full ml-1 w-56 rounded-md shadow-lg bg-white opacity-0 invisible group-hover/level2:opacity-100 group-hover/level2:visible transition-all duration-300">
                                <div class="py-1">
                                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" data-translate-key="academic">Akademik</a>
                                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" data-translate-key="non_academic">Non-Akademik</a>
                                </div>
                            </div>
                        </div>
