            ...
            <div class="relative">
                ...
                <div id="menu-student_life"
                    ...
                    <div class="py-1">
                        ...
                        <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                            data-translate-key="achievements">Prestasi</a>
                        <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                    ...
                    <div class="py-1">
                        <div class="relative group/level2">
                            <a href="#"
                                ...
                                Daftar Sekarang
                                <svg class="w-4 h-4 transform -rotate-90 transition-transform group-hover/level2:rotate-0"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const translations = {
            ...
            registration_steps: {
                id: "5 Langkah Pendaftaran",
                en: "5 Steps for Registration"
            },
            after_registration_steps: {
                id: "5 Langkah setelah Penerimaan",
                en: "5 Steps after Admission"
            },
            school_fees: {
                id: "Biaya Sekolah",
                en: "School Fees"
