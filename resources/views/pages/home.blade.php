...
@section('content')
    <section class="bg-cover bg-center w-full h-screen relative bg-gray-800 overflow-hidden">
        <!-- Gradient Overlay -->
        <div
            class="absolute inset-0 bg-gradient-to-r from-gray-800/80 sm:from-gray-800/90 via-gray-800/50 sm:via-gray-800/60 to-transparent z-10">
        </div>
        <!-- Content -->
                ...
                <div class="max-w-4xl space-y-2 lg:space-y-4 animate-fade-in">
                    ...
                    <div class="pt-4">
                        <a href="#tentang"
                            ...
                            EXPLORE
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-auto w-4 sm:w-5" viewBox="0 0 20 20"
                                fill="currentColor">
