...
<x-social-bar />
    ...
    <!--SECTION SEKILAS SMK -->
    <section class="px-6 sm:px-20 w-full min-h-screen py-20 flex flex-col items-center justify-center" id="about-section">
        <h1 class="mx-auto text-center text-3xl sm:text-4xl text-blue-900 section-title">
            <span data-translate-key="about_section_sekilas">Sekilas</span> 
            <span class="text-orange-400 font-bold highlight-text" data-translate-key="about_section_highlight">SMK PRESTASI PRIMA</span>
        </h1>
        ...
        <div class="flex flex-col md:flex-row mt-8 px-0 md:px-40 space-y-4 md:space-y-0 md:space-x-4 content-container w-full">
            <div class="rounded-xl shadow-xl flex-1 flex items-center text-card">
                <p class="text-blue-900 py-10 sm:py-20 px-6 sm:px-10 my-auto text-md" data-translate-key="about_section_text">
